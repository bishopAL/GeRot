...
(cl:defmethod cl:initialize-instance :after ((m <KeyValue>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyValue)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name diagnostic_msgs-msg:<KeyValue> is deprecated: use diagnostic_msgs-msg:KeyValue instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <KeyValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic_msgs-msg:key-val is deprecated.  Use diagnostic_msgs-msg:key instead.")
  (key m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <KeyValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic_msgs-msg:value-val is deprecated.  Use diagnostic_msgs-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyValue>)))
  ...
  (cl:format cl:nil "string key # what to label this value when viewing~%string value # a value to track over time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyValue)))
  "Returns full string definition for message of type 'KeyValue"
  (cl:format cl:nil "string key # what to label this value when viewing~%string value # a value to track over time~%~%~%"))
