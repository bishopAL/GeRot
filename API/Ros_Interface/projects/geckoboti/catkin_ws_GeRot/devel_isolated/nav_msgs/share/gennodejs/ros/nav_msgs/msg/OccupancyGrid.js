...
class OccupancyGrid {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MapMetaData.serialize(obj.info, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.info = MapMetaData.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.info !== undefined) {
      resolved.info = MapMetaData.Resolve(msg.info)
    }
    else {
      resolved.info = new MapMetaData()
    }
