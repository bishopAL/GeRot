...
class NavSatFix {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavSatStatus.serialize(obj.status, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavSatFix(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = NavSatStatus.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavSatFix(null);
    ...
    if (msg.status !== undefined) {
      resolved.status = NavSatStatus.Resolve(msg.status)
    }
    else {
      resolved.status = new NavSatStatus()
    }
