...
(cl:defmethod cl:initialize-instance :after ((m <Image>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Image)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_msgs-msg:<Image> is deprecated: use sensor_msgs-msg:Image instead.")))
...
(cl:defmethod step-val ((m <Image>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_msgs-msg:step-val is deprecated.  Use sensor_msgs-msg:step instead.")
  (step m))
