...
# step 0
p_detach, v_detach, para_detach = gecko.detach('rf', detach_time, time_period, width, height)
p_moving0, v_moving0, para_moving0 = gecko.moving('rf', attach_time0, time_period, np.array([gecko.L1 - horizen, gecko.present_position['rf'][1] - width,
                                                             gecko.present_position['rf'][2] - (height + depth)]), para=0.1)
p_moving1, v_moving1, para_moving1 = gecko.moving('rf', attach_time1, time_period, np.array([gecko.L1 - horizen, gecko.present_position['rf'][1] ,
...
p_moving0, v_moving0, para_moving0 = gecko.moving('rh', attach_time0, time_period, np.array([gecko.L1 - horizen, gecko.present_position['rh'][1] - width,
                                                             gecko.present_position['rh'][2] - (height + depth)]), para=0.1)
p_moving1, v_moving1, para_moving1 = gecko.moving('rh', attach_time1, time_period, np.array([gecko.L1 - horizen, gecko.present_position['rh'][1],
...
# moving 0
rf_target_p, rf_target_v, rf_target_para = gecko.moving('rf', moving_time, time_period, np.array([gecko.L1 - horizen/2, gecko.present_position['rf'][1],
                                                                 gecko.present_position['rf'][2]]), para=0.5)
rh_target_p, rh_target_v, rh_target_para = gecko.moving('rh', moving_time, time_period, np.array([gecko.L1 - horizen/2, gecko.present_position['rh'][1],
                                                                 gecko.present_position['rh'][2]]), para=0.5)
lf_target_p, lf_target_v, lf_target_para = gecko.moving('lf', moving_time, time_period, np.array([gecko.L1 - horizen/2, gecko.present_position['lf'][1],
                                                                 gecko.present_position['lf'][2]]), para=0.5)
lh_target_p, lh_target_v, lh_target_para = gecko.moving('lh', moving_time, time_period, np.array([gecko.L1 - horizen/2, gecko.present_position['lh'][1],
...
p_moving0, v_moving0, para_moving0 = gecko.moving('lf', attach_time0, time_period, np.array([gecko.L1 + horizen/2, gecko.present_position['lf'][1] - width,
                                                             gecko.present_position['lf'][2] - (height + depth)]), para=0.1)
p_moving1, v_moving1, para_moving1 = gecko.moving('lf', attach_time1, time_period, np.array([gecko.L1 + horizen/2, gecko.present_position['lf'][1],
...
p_moving0, v_moving0, para_moving0 = gecko.moving('lh', attach_time0, time_period, np.array([gecko.L1 + horizen/2, gecko.present_position['lh'][1] - width,
                                                             gecko.present_position['lh'][2] - (height + depth)]), para=0.1)
p_moving1, v_moving1, para_moving1 = gecko.moving('lh', attach_time1, time_period, np.array([gecko.L1 + horizen/2, gecko.present_position['lh'][1],
...
target_para = np.vstack((target_para0, target_para2, target_para_m0, target_para1, target_para3, target_para_m1))
