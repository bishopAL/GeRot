...
p_moving0, v_moving0 = gecko.moving('rh', attach_time0, time_period, np.array([gecko.L1, gecko.present_position['rh'][1],
                                                             gecko.present_position['rh'][2] - (height + depth)]))
p_moving1, v_moving1 = gecko.moving('rh', attach_time1, time_period, np.array([gecko.L1, gecko.present_position['rh'][1],
...
p_moving0, v_moving0 = gecko.moving('lf', attach_time0, time_period, np.array([gecko.L1, gecko.present_position['lf'][1],
                                                             gecko.present_position['lf'][2] - (height + depth)]))
p_moving1, v_moving1 = gecko.moving('lf', attach_time1, time_period, np.array([gecko.L1, gecko.present_position['lf'][1],
...
p_moving0, v_moving0 = gecko.moving('lh', attach_time0, time_period, np.array([gecko.L1, gecko.present_position['lh'][1],
                                                             gecko.present_position['lh'][2] - (height + depth)]))
p_moving1, v_moving1 = gecko.moving('lh', attach_time1, time_period, np.array([gecko.L1, gecko.present_position['lh'][1],
